...
\pH Controller1, Controller2 or the G2 front panel controller.
...
not).
It is possible to change the options without actually changing one of the files in the \pH repository.
Simply go (in a terminal window) to the directory where you compile \pH and type in
