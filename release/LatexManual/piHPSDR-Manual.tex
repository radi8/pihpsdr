...
\textbf{\color{red}Virtual audio cables. Linux ALSA case.} \\
...
\clearpage
\textbf{\color{red}Virtual audio cables, PulseAudio case.}\\
...
In MacOS, the easist, most flexible, and (from my side) most recommended option is
